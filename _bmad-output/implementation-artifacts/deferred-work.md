...
> **Rituel (acté rétro Epic 8, 2026-06-21)** : ce fichier passe en revue **avant le démarrage de chaque nouvelle epic**. Chaque item est tranché — _fix maintenant_ / _story planifiée_ / _gardé-avec-raison_ / _tué_. Il ne doit jamais redevenir un cimetière. Dernière passe : **2026-07-05** (post-rétro Epic 14, avant epic « signal UX rate-limit » — **A5 promu prochaine epic** avec le résidu **7-13 oracle de timing** rattaché ; les 3 deferrals Epic 14 tranchés (14-3 caduc, 14-1/14-2 🧊 gardés) ; tous les autres résidus de review + le bloc § 🧊 re-confirmés 🧊 gardés à l'échelle beta mono-user ; rien tué hors caduc, rien à fixer en urgence). Passe précédente : 2026-07-04 (avant epic confort mobile — lot UX/UI mobile promu).
