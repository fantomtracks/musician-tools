...
- **Secrets no longer travel into the deployed image.** The backend `.env` file was being copied into the Docker image alongside the code. It is now excluded from the build.
